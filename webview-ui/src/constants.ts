...
export const WAKE_DURATION_SEC = 0.8;
export const WAKE_FRAME_DURATION_SEC = 0.1;
export const RUN_SPEED_PX_PER_SEC = 120;
export const RUN_FRAME_DURATION_SEC = 0.075;
